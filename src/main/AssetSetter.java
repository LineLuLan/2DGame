...
//        i++;
    ...
    public void setMonster() {
        ...
        mapNum = 4;
        i = 0;
        gp.monster[mapNum][i] = new MON_Snow_Man(gp);
        ...
        i++;
        gp.monster[mapNum][i] = new MON_IceSlime(gp);
        ...
        gp.monster[mapNum][i].worldX = gp.tileSize*18;
        gp.monster[mapNum][i].worldY = gp.tileSize*36;
        i++;gp.monster[mapNum][i] = new MON_Orc(gp);
    ...
    public void setInteractiveTile(){
        ...
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 36, 39); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 38, 39); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 38, 39); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 38, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 38, 41); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 31, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 32, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 32, 41); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 33, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 34, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 35, 40); i++;
        gp.iTile[mapNum][i] = new IT_DryTree(gp, 36, 40); i++;
        mapNum = 2;
        i = 0;
